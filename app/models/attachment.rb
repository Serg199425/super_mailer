class Attachment < ActiveRecord::Base
  ...
  has_attached_file :file, :url => "/attachments/user_:user_id/message_id_:message_id/:basename.:extension",
                    :path => "#{Rails.root}/public/attachments/user_:user_id/message_id_:message_id/:basename.:extension"
